...
Also watch for sample listings the user provides during a session. If the user pastes or uploads a past listing the consultant wrote, ask: "Should I add this to Colin Tunn's sample library for future tone reference?" If yes, save it to knowledge/sample-listings/ with a descriptive filename.
